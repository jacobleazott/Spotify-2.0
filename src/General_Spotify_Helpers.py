...
class GeneralSpotifyHelpers:
    ...
    # ═════════════════════════════════════════════════════════════════════════════════════════════════════════════════
    # DATABASE HELPERS ════════════════════════════════════════════════════════════════════════════════════════════════
    # Thesee functions really "shouldn't" be in this class. I wasn't sure where else to put them for now. I want ══════
    #   them to be easily accessible for every feature to use, but this class should JUST be API abstractions. ════════
    #   All to say they may be moved to another file/ class if this section continues to grow. ════════════════════════
    # ═════════════════════════════════════════════════════════════════════════════════════════════════════════════════
    ...
    def db_get_tracks_from_playlist(self, playlist_id: str, grab_from_spotify: bool=False) -> list[str]:
        ...
        backup_db_conn = sqlite3.connect(latest_backup_file)
        query = f"""
                SELECT tracks.*
                FROM tracks
                ...
                """
        playlist_tracks = [track[0] for track in backup_db_conn.execute(query).fetchall()]
