...
from Backup_Spotify_Data import BackupSpotifyData, replace_none
...
class TestBackupSpotifyData(unittest.TestCase):
    ...
    def test_get_column_types(self):
        ...
        # Assert that the get_column_types function returns the correct types.
        self.assertEqual(self.backup.get_column_types("test_table"), [int, str, float, bytes, float])
        ...
        # Assert that unsupported types default to str.
        self.assertEqual(self.backup.get_column_types("test_unsupported"), [int, str])
